...
allow_creds = os.getenv("CORS_ALLOW_CREDENTIALS", "false").lower() in ("1","true","yes")
...
from dashboard.backend.tool_routes import tool_router
from dashboard.backend.role_routes import role_router
from dashboard.backend.skill_routes import skill_router
from dashboard.backend.budget_routes import budget_router
from dashboard.backend.notifier_routes import notifier_router
from dashboard.backend.evolution_routes import evolution_router
