...
def evaluate_with_consensus(
    ...
    skill_text = _load_code_eval_skill()
...
def _load_code_eval_skill() -> str:
    """Charge le skill 'code-evaluation' si disponible (few-shot calibrage)."""
    try:
        from queen_core.skill_registry import get_skill_registry
        reg = get_skill_registry()
        return reg.read_skill("code-evaluation") or ""
    except Exception:
        return ""
