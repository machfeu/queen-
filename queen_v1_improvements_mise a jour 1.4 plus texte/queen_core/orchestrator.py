...
from queen_core.policy import validate_goal_constraints, get_job_budget
from queen_core.job_chain import enrich_job_payload
from queen_core import redis_bus

# Import notifier (optional, graceful fallback)
try:
...
def _run_gates(artifacts, goal_id: str) -> Dict[str, Any]:
    ...
    path_errors = []
    for art in artifacts:
        from queen_core.policy import validate_file_path
